...
void loop() {
  ...
  buttonPressed = CircuitPlayground.leftButton(); //press left button
  ...
  CircuitPlayground.playTone(freq,1000); //play tone when left buttion is pressed

  delay(200);

/////////color the pixels one after the other, fast then slow
